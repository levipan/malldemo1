...
![](https://img-blog.csdnimg.cn/30e2bcc6266249809041009d4c3438e9.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA57yW56iL5bCP55-z5aS0,size_11,color_FFFFFF,t_70,g_se,x_16)
排号成功后可以查看排号情况
![](https://img-blog.csdnimg.cn/e7bf59b5bb684cd4a74281d14ab472b5.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA57yW56iL5bCP55-z5aS0,size_11,color_FFFFFF,t_70,g_se,x_16)

## 20-2，管理员端
管理员可以管理当前排号情况
![](https://img-blog.csdnimg.cn/1181dcfe4c264f078f98af5e7ce5cdc7.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA57yW56iL5bCP55-z5aS0,size_12,color_FFFFFF,t_70,g_se,x_16)
我会在代码里带着大家一步步去实现排号功能

# 二十一，菜品分类功能
## 21-1，为什么做菜品分类
先来回忆下菜品分类页的效果图。其实当我们菜品增多时，通过搜索是可以快速定位到某一个菜品，但是呢，如果通过菜品分类，让用户去选择购买，肯定会更方便客户的。
![](https://img-blog.csdnimg.cn/5b7e776a8c7d422bad978d346471945f.png)
## 22-2，菜品分类的实现原理
其实呢， 我们的菜品分类就是左侧的菜品类型列表，和右侧的每个菜品分类下的菜品列表。
![](https://img-blog.csdnimg.cn/da92fab6649e42349b07805096c5c469.png)
我会在视频里带着大家一步步的实现菜品分类功能的，希望大家认真的跟着石头哥的视频教程走。
## 22-3，菜品分组查询
我们想知道菜品都有哪些分类，我们就要通过聚合分组操作，拿到目前所有菜品的分组。就是要知道我们的菜品有哪些分类。
![](https://img-blog.csdnimg.cn/470795cfd0fe4817ac8616f6c71d96b2.png)
这里我们用到了云开发官方的一个聚合操作。
![](https://img-blog.csdnimg.cn/f6903eb6d5024db399c742fbabc4efc5.png)
对应的文档如下：
